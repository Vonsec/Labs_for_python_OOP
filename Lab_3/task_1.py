...
class PaperBook(Book):
    ...
    @property
    def pages(self):
        """Количество страниц (только для чтения)."""
        return self._pages
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}(name={self.name!r}, " f"author={self.author!r}, pages={self.pages!r})"
...
class AudioBook(Book):
    ...
    @property
    def duration(self):
        """Продолжительность аудиокниги в часах (только для чтения)."""
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}(name={self.name!r}, " f"author={self.author!r}, duration={self.duration!r})"
